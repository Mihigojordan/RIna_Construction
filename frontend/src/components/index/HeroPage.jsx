...
const HeroPage = () => {
  ...
  const words = [
    ...
    "Expert Civil Engineering & Construction Solutions",
    "Your Trusted Partner in Building Dreams",
  ];

  // Service tags for each slide
  const serviceTypes = [
    ...
    <div className="w-full bg-gray- overflow-hidden rounded-2xl">
      <div className="relative h-screen md:h-[560px] rounded-xl">
        ...
        <div className="absolute bottom-6 right-6 bg-[#293751]/90 backdrop-blur-md p-4 rounded-xl text-white max-w-xs border border-cyan-400/30 shadow-xl z-10">
          <h3 className="text-sm font-semibold mb-1 text-cyan-300">Premium Service</h3>
          <p className="text-xs opacity-90">
            Explore our {serviceTypes[currentSlide].toLowerCase()} tailored to meet your needs.
          </p>
        </div>
