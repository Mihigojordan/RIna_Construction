...
const About = () => {
  ...
  const qualities = [
    "expert civil engineering design",
    "professional construction planning",
    "reliable structural analysis services",
    ...
    >
      ...
      <div className="w-full flex flex-col gap-5 lg:w-1/2 p-8 pt-10 flex-auto relative z-10">
        ...
        >
          ...
          >
            Welcome to RANI CONSTRUCTION COMPANY LTD, your trusted civil engineering partner. We specialize
            ...
            to ensure your construction projects are built to last.
          </motion.span>
        </motion.p>
      ...
      <div className="md:w-1/2 lg:w-5/12 w-full p-6 h-[600px] object-cover flex-auto relative">
        ...
        >
          ...
          <motion.img
            ...
            alt="About Kalinga Construction"
