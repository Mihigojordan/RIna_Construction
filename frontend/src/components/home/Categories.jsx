...
const Categories = () => {
  ...
  const categories = [
    { icon: Building, name: 'Commercial Construction', count: '50+ Projects' },
    { icon: Home, name: 'Residential Buildings', count: '100+ Homes' },
    { icon: HardHat, name: 'Civil Engineering', count: '30+ Developments' },
    { icon: Ruler, name: 'Architectural Design', count: '200+ Plans' },
    { icon: DraftingCompass, name: 'Renovation & Remodeling', count: '75+ Renovations' },
    { icon: ClipboardList, name: 'Project Management', count: '150+ Managed' },
    { icon: Wrench, name: 'Site Development', count: '40+ Sites' },
    { icon: Crane, name: 'Infrastructure', count: '25+ Projects' },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
            Discover Rani Construction Company Ltd&apos;s comprehensive range of construction services designed to bring your vision to life with quality craftsmanship and innovative building solutions
          </p>
        </div>
        ...
        <div className="text-center mt-16">
          <div className="inline-flex items-center gap-3 bg-white px-8 py-4 rounded-full shadow-lg border border-gray-100 hover:shadow-xl hover:border-primary-200 transition-all duration-300 cursor-pointer group">
            <span className="text-gray-700 font-medium">View All Services</span>
